     ...
     <table class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info" id="laravel_crud">
            ...
            @foreach($clas as $u_info)
                <tr id="user_id_{{ $u_info->id }}">
                    ...
                    <td class="text regular">{{ $u_info->calssfcation_type}}</td>        
                 ...
                 <div class="modal-body">
                    ...
                    <form id="userForm" name="userForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="calssfcation_type" name="calssfcation_type"
                ...
                $('body').on('click','#edit-user', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            $('#user_id').val(user_id);
                            $('#calssfcation_type').val(data.calssfcation_type);
