...
@extends('admin.admin_template')
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.blade.php">Car<span>Book</span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item"><a href="index.blade.php" class="nav-link">Home</a></li>
	          <li class="nav-item"><a href="about.blade.php" class="nav-link">About</a></li>
	          <li class="nav-item"><a href="services.blade.php" class="nav-link">Services</a></li>
	          <li class="nav-item"><a href="pricing.blade.php" class="nav-link">Pricing</a></li>
	          <li class="nav-item"><a href="car.blade.php" class="nav-link">Cars</a></li>
	          <li class="nav-item active"><a href="blog.blade.php" class="nav-link">Blog</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.blade.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="blog.blade.php">Blog <i class="ion-ios-arrow-forward"></i></a></span> <span>Blog Single <i class="ion-ios-arrow-forward"></i></span></p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <p>
              <img src="../../../../public/images/image_7.jpg" alt="" class="img-fluid">
            </p>
            ...
            <p>
              <img src="../../../../public/images/image_8.jpg" alt="" class="img-fluid">
            </p>
